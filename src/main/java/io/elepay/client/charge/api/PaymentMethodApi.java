...
public class PaymentMethodApi {
  ...
  public PaymentMethodResponse listPaymentMethods() throws ApiException {
    return this.listPaymentMethods(Collections.emptyMap());
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public PaymentMethodResponse listPaymentMethods(Map<String, String> additionalHeaders) throws ApiException {
