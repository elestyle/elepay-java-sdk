...
public class ChargeApi {
   ...
   * @param from 開始時間（エポックミリ秒）、指定した時間以降に作成されたデータを取得します (optional)
   * @param to 終了時間（エポックミリ秒）、指定した時間以前に作成されたデータを取得します (optional)
   * @param dateField 開始時間と終了時間の項目を指定します。 - paid_time 支払い時間 - create_time 決済新規時間  (optional, default to create_time)
   * @param status 支払状況 (optional)
   * @param limit 最大件数 (optional, default to 20)
   * @param offset 検索開始位置 (optional, default to 0)
   * @param sort ソート項目 - paid_time 支払い時間 - create_time 決済新規時間  (optional, default to create_time)
