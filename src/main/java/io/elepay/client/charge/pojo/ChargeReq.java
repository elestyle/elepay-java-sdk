...
public class ChargeReq {
  ...
  **/
  ...
  public ChargeReq orderNo(String orderNo) {
   ...
   /**
   * お客様側のシステムオーダーNo（例：注文番号、決済IDなど） 最大桁数は20桁です。 
   * @return orderNo
  **/
  @ApiModelProperty(required = true, value = "お客様側のシステムオーダーNo（例：注文番号、決済IDなど） 最大桁数は20桁です。 ")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(amount, currency, paymentMethod, resource, orderNo, description, extra, metadata, clientIp, customerId, sourceId);
  }
