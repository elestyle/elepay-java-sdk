...
public class CodeDto {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, _object, liveMode, codeUrl, amount, currency, orderNo, description, extra, metadata, status, charge, frontUrl, items, expired, expiryTime, expiryPeriod, createTime);
  }
