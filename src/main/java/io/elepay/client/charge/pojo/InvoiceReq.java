...
@JsonPropertyOrder({
  ...
  InvoiceReq.JSON_PROPERTY_ENABLE_AUTO_CHARGE,
  InvoiceReq.JSON_PROPERTY_AUTO_CHARGE_TIME
})
...
public class InvoiceReq {
  ...
  public static final String JSON_PROPERTY_ENABLE_AUTO_CHARGE = "enableAutoCharge";
  private Boolean enableAutoCharge = false;

  public static final String JSON_PROPERTY_AUTO_CHARGE_TIME = "autoChargeTime";
  ...
  **/
  ...
  public InvoiceReq enableAutoCharge(Boolean enableAutoCharge) {
  ...
  **/
  @jakarta.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_ENABLE_AUTO_CHARGE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(JSON_PROPERTY_ENABLE_AUTO_CHARGE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEnableAutoCharge(Boolean enableAutoCharge) {
    this.enableAutoCharge = enableAutoCharge;
  }


  public InvoiceReq autoChargeTime(Long autoChargeTime) {
  ...
  **/
  @jakarta.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_AUTO_CHARGE_TIME)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(JSON_PROPERTY_AUTO_CHARGE_TIME)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAutoChargeTime(Long autoChargeTime) {
    this.autoChargeTime = autoChargeTime;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, invoiceReq.name) &&
        ...
        Objects.equals(this.enableAutoCharge, invoiceReq.enableAutoCharge) &&
        Objects.equals(this.autoChargeTime, invoiceReq.autoChargeTime);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, memo, customerId, amount, currency, taxType, taxCalcType, invoiceTime, expiryTime, fields, items, remark, metadata, enableAutoCharge, autoChargeTime);
  }
  ...
  public String toString() {
    ...
    sb.append("    enableAutoCharge: ").append(toIndentedString(enableAutoCharge)).append("\n");
    sb.append("    autoChargeTime: ").append(toIndentedString(autoChargeTime)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `enableAutoCharge` to the URL query string
    if (getEnableAutoCharge() != null) {
      try {
        joiner.add(String.format("%senableAutoCharge%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getEnableAutoCharge()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    // add `autoChargeTime` to the URL query string
    if (getAutoChargeTime() != null) {
      try {
        joiner.add(String.format("%sautoChargeTime%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getAutoChargeTime()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
