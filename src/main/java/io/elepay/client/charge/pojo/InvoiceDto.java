...
@JsonPropertyOrder({
  ...
  InvoiceDto.JSON_PROPERTY_ENABLE_AUTO_CHARGE
})
...
public class InvoiceDto {
  ...
  **/
  ...
  public InvoiceDto enableAutoCharge(Boolean enableAutoCharge) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, invoiceDto.id) &&
        ...
        Objects.equals(this.enableAutoCharge, invoiceDto.enableAutoCharge);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, _object, liveMode, customer, invoiceNo, name, memo, amount, currency, status, operator, invoiceTime, sendTime, paidTime, expiryTime, createTime, fields, items, remark, metadata, enableAutoCharge);
  }
