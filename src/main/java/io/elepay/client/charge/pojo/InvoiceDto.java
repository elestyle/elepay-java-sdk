...
public class InvoiceDto {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, _object, liveMode, customer, invoiceNo, name, memo, amount, currency, status, operator, sendTime, paidTime, expiryTime, createTime, items, remark, metadata);
  }
