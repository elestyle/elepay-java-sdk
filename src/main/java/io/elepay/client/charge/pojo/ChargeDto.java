...
@JsonPropertyOrder({
  ...
  ChargeDto.JSON_PROPERTY_LOCATION,
...
public class ChargeDto {
  ...
  private ChargeLocationDto location;
  ...
  **/
  ...
  public ChargeDto location(ChargeLocationDto location) {
  ...
  **/
  ...
  public ChargeLocationDto getLocation() {
    return location;
  }
  ...
  @JsonProperty(JSON_PROPERTY_LOCATION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setLocation(ChargeLocationDto location) {
    this.location = location;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, chargeDto.id) &&
        ...
        Objects.equals(this.location, chargeDto.location) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, appId, _object, liveMode, amount, authorizeAmount, currency, authorize, paymentMethod, resource, orderNo, description, location, extra, metadata, cardInfo, voucherNo, clientIp, paid, refunded, disputed, refunds, status, codeContent, credential, paidTime, refundTime, expiryTime, settleTime, createTime);
  }
