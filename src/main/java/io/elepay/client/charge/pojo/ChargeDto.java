...
public class ChargeDto {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, _object, liveMode, amount, currency, paymentMethod, resource, orderNo, description, extra, metadata, cardInfo, voucherNo, clientIp, paid, refunded, refunds, status, credential, paidTime, refundTime, expiryTime, settleTime, createTime);
  }
