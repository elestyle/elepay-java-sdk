...
public class ChargeDto {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, appId, _object, liveMode, amount, currency, paymentMethod, resource, orderNo, description, extra, metadata, cardInfo, voucherNo, clientIp, paid, refunded, disputed, refunds, status, codeContent, credential, paidTime, refundTime, expiryTime, settleTime, createTime);
  }
