...
import io.elepay.client.charge.auth.Authentication;
import io.elepay.client.charge.auth.HttpBasicAuth;
import io.elepay.client.charge.auth.HttpBearerAuth;
import io.elepay.client.charge.auth.ApiKeyAuth;
...
public class ApiClient {
  ...
  protected String basePath = "https://api.elepay.io";
  ...
  public ApiClient() {
    ...
    setUserAgent("OpenAPI-Generator/1.1.11/java");
