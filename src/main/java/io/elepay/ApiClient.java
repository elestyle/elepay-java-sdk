...
import io.elepay.auth.Authentication;
import io.elepay.auth.HttpBasicAuth;
import io.elepay.auth.HttpBearerAuth;
import io.elepay.auth.ApiKeyAuth;
...
public class ApiClient {
  ...
  public ApiClient() {
    ...
    setUserAgent("OpenAPI-Generator/1.0.3/java");
